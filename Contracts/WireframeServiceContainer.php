...
namespace Fabricate\Chassis\Contracts;

use Fabricate\Contracts\Chassis\ContextualBindingBuilder;
use Fabricate\Contracts\Chassis\ServiceContainer as ServiceContainerContract;
use InvalidArgumentException;
use LogicException;

interface WireframeServiceContainer extends ServiceContainerContract
{
    /**
